            ...
            <div className="container mx-auto px-4">
              ...
              <div className="w-full py-3">
                <div className="w-full rounded-xl p-3 bg-[#222632] flex items-center">
                  ...
                  <div className="flex-1 ml-6 h-44 ">
                    ...
                    <p className="text-xs text-gray-400 mt-3">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis eaque deleniti maiores placeat nesciunt esse impedit quaerat est ad. Cumque at, harum qui repellendus, voluptatibus nesciunt adipisci vitae fuga aut velit ipsam explicabo iusto, saepe praesentium itaque esse hic molestiae earum similique. Aut sed asperiores odio sequi qui perferendis placeat labore non neque nobis excepturi est, dicta, nulla cupiditate possimus corrupti cum, eligendi nisi ducimus! Rerum repellendus aspernatur necessitatibus hic?
                    </p>
                  </div>
                </div>
              </div>
