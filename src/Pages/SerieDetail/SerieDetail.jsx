          ...
          <div className="w-full bg-[#0e0d12] pt-6">
            <div className="container mx-auto px-4">
              ...
              <div className="w-full flex items-center py-3 font-montserrat text-white flex-wrap border-b border-[#394253]">
                <button className="p-3 bg-cyan text-xs mr-2 mb-2 ">
                  Season 1
                </button>
                <button className="p-3 bg-gray-800 text-xs mr-2 mb-2">
                  Season 1
                </button>
                <button className="p-3 bg-gray-800 text-xs mr-2 mb-2">
                  Season 1
              ...
              <div className="w-full py-3 space-y-2">
                <div className="w-full rounded-xl p-3 bg-[#222632] flex items-center">
                  <img
                    src="	https://image.tmdb.org/t/p/original/oFvjxSIPYv5YXspDlnWeDJhnPHI.jpg"
                    alt=""
                    className="h-44 w-80 rounded-xl"
                  />

                  <div className="flex-1 ml-6 h-44 flex flex-col justify-between">
                    <div className="w-full flex items-center justify-between font-montserrat">
                      {/* episode title */}
                      <div className="flex items-center">
                        <span className="w-8 h-8 rounded-full bg-[#131722] flex items-center justify-center text-white mr-3">
                          1
                        </span>
                      ...
                      <div className="flex items-center">
                        ...
                        <p className="text-lg font-semibold text-white">9.2</p>
                      </div>
                    </div>

                    <p className="text-xs text-gray-400 mt-3">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Omnis eaque deleniti maiores placeat nesciunt esse impedit
                      quaerat est ad. Cumque at, harum qui repellendus,
                      voluptatibus nesciunt adipisci vitae fuga aut velit ipsam
                      explicabo iusto, saepe praesentium itaque esse hic
                      molestiae earum similique. Aut sed asperiores odio sequi
                      qui perferendis placeat labore non neque nobis excepturi
                      est, dicta, nulla cupiditate possimus corrupti cum,
                      eligendi nisi ducimus! Rerum repellendus aspernatur
                      necessitatibus hic?
                    </p>
                    ...
                    <div className="w-full flex">
                      <a
                        ...
                        className="px-4 text-center text-xs py-2 md:py-2 bg-cyan text-white rounded-md hover:opacity-60 duration-200"
                      >
                        Explore
                      </a>

                      <button
                        className="px-4 text-center text-xs py-2 md:py-2 border border-cyan text-cyan 
                      rounded-md hover:bg-cyan hover:text-white duration-200 ml-2"
                      >
                        + WatchList
                      </button>

                      <button className="px-4 text-center text-xs py-2 md:py-2 border border-green-400 text-green-400 rounded-md hover:bg-green-400 hover:text-white duration-200 ml-2">
                        + My Lists
                      </button>
                    </div>
                  </div>
