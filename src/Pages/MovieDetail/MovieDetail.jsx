...
export default function MovieDetail() {
  ...
  useEffect(() => {
    if (MovieDetails) {
      ...
      Store.dispatch(fetchMovieReviews({ id: params.id, page: 1 }));
    }
  }, [MovieDetails]);
        ...
        <>
          ...
          <div className="w-full bg-[#0e0d12] text-white">
            <div className="container mx-auto py-4 px-4">
              ...
              <div className="w-full flex justify-between space-x-0 space-y-2 md:space-x-3 md:space-y-0 flex-col md:flex-row">
                <div className="py-3 border min-w-96 flex-1"></div>
                <div className="space-y-3 max-w-5xl">
                  {MovieReviews &&
                    MovieReviews.results.length > 0 &&
                    MovieReviews.results.map((review) => (
                      <div className="w-full">
                        <button className="w-full rounded-xl p-4 bg-[#131722]">
                          {/* Review Header */}
                          ...
                          {/* Review Body */}
                          <div className="w-full line-clamp-2 md:line-clamp-1 mt-4 text-left text-gray-300">
                            {review.content}
                          </div>
                        </button>
                      </div>
