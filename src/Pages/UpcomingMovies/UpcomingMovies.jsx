...
import { fetchUpcomingMovies } from "../../Redux/Reducers/Movies";
...
export default function UpcomingMovies() {
  ...
  useEffect(() => {
    if (MovieGenres && page > 1) {
      Store.dispatch(fetchUpcomingMovies({ page }));
    }
  }, [MovieGenres, page]);
...
//   console.log(TheaterMovies);
  ...
  useEffect(() => {
    if (UpcomingMovies) {
      setMoviesList([...moviesList, ...UpcomingMovies.results]);
    }
  }, [UpcomingMovies]);
          ...
          <div className="container mx-auto px-4 flex flex-col items-center ">
            ...
            <div className="w-full flex flex-col items-center mt-6">
              ...
              <h4 className="text-gray-500 font-montserrat text-xs sm:text-sm">
                Total Results : {UpcomingMovies && UpcomingMovies.total_results}
              </h4>
            </div>
